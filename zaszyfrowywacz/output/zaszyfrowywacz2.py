...
# Form implementation generated from reading ui file 'zaszyfrowywaczDWA.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(350, 234)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("zasz2.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
